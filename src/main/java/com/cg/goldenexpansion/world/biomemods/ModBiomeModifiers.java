package com.cg.goldenexpansion.world.biomemods;
...
{
	public static final DeferredRegister<Codec<? extends BiomeModifier>> BIOME_MODIFIERS = DeferredRegister.create(ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, GoldenExpansion.MOD_ID);
