...
public class ModBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags()
	{
		...
		tag(BlockTags.SIGNS).add(BlockInit.GOLDEN_PLANKS.get());
		tag(BlockTags.SAPLINGS).add(BlockInit.GOLDEN_PLANKS.get());
		tag(BlockTags.FENCE_GATES).add(BlockInit.GOLDEN_PLANKS.get());
		tag(BlockTags.WOODEN_BUTTONS).add(BlockInit.GOLDEN_PLANKS.get());
		tag(BlockTags.WOODEN_DOORS).add(BlockInit.GOLDEN_PLANKS.get());
		tag(BlockTags.WOODEN_FENCES).add(BlockInit.GOLDEN_PLANKS.get());
		tag(BlockTags.WOODEN_PRESSURE_PLATES).add(BlockInit.GOLDEN_PLANKS.get());
		tag(BlockTags.WOODEN_SLABS).add(BlockInit.GOLDEN_PLANKS.get());
		tag(BlockTags.WOODEN_STAIRS).add(BlockInit.GOLDEN_PLANKS.get());
		tag(BlockTags.WOODEN_TRAPDOORS).add(BlockInit.GOLDEN_PLANKS.get());
